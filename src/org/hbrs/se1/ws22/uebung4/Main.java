...
public class Main {
    ...
    public static void main(String[] args) throws ContainerException, PersistenceException, IOException {
        ...
        while(true){
            ...
            switch(params[0]){
                case "enter":
                    if(!Pattern.matches("[a-zA-ZäöüÄÖÜ]+", params[1]) || !Pattern.matches("[a-zA-ZäöüÄÖÜ]+", params[2])){ // Regex check
                        System.out.println("Ungültiges Zeichen im Namen!");
                        break;
                    }
                ...
                case "load":
                    ...
                    break;
                case "dump":
                    // Memberview.dump() ist unsortiert
